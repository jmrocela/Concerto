...
update_option('concerto_design_fonts_header', 'inherit-body');
update_option('concerto_design_fonts_content', 'georgia');
update_option('concerto_design_fonts_content_title', 'arial');
update_option('concerto_design_fonts_sidebar', 'inherit-content');
update_option('concerto_design_fonts_footer', 'inherit-body');

update_option('concerto_design_sizes_body', 12);
update_option('concerto_design_sizes_menu', 'inherit-body');
update_option('concerto_design_sizes_header_title', 40);
update_option('concerto_design_sizes_header_description', 14);
update_option('concerto_design_sizes_content', 15);
update_option('concerto_design_sizes_content_title', 28);
update_option('concerto_design_sizes_content_meta', 13);
update_option('concerto_design_sizes_sidebar', 'inherit-content');
update_option('concerto_design_sizes_h1', 28);
update_option('concerto_design_sizes_h2', 25);
update_option('concerto_design_sizes_h3', 20);
update_option('concerto_design_sizes_h4', 16);
update_option('concerto_design_sizes_h5', 14);
update_option('concerto_design_sizes_h6', 14);
update_option('concerto_design_sizes_footer', 11);

update_option('concerto_design_colors_background_site', '#ffffff');
update_option('concerto_design_colors_background_container', '#ffffff');
update_option('concerto_design_colors_background_header', 'none');
update_option('concerto_design_colors_background_main', '#ffffff');
update_option('concerto_design_colors_background_content', '#ffffff');
update_option('concerto_design_colors_background_footer', 'none');
update_option('concerto_design_colors_background_menu', '#ffffff');
update_option('concerto_design_colors_background_menu_active', '#ffffff');
update_option('concerto_design_colors_background_menu_hover', '#ffffff');
update_option('concerto_design_colors_background_article', '#ffffff');
...
update_option('concerto_design_colors_borders_menu_hover', '#dddddd');
update_option('concerto_design_colors_borders_article_top', 'transparent');
update_option('concerto_design_colors_borders_article_bottom', 'transparent');
update_option('concerto_design_colors_borders_article', 'transparent');
update_option('concerto_design_colors_borders_comment', 'transparent');
update_option('concerto_design_colors_borders_comment_top', 'transparent');
...
update_option('concerto_design_borders_header_top', 0);
update_option('concerto_design_borders_header_bottom', 1);
update_option('concerto_design_borders_menu', 1);
update_option('concerto_design_borders_footer', 0);
update_option('concerto_design_borders_footer_top', 1);
update_option('concerto_design_borders_footer_bottom', 0);
update_option('concerto_design_borders_article', 0);
update_option('concerto_design_borders_article_top', 0);
update_option('concerto_design_borders_article_bottom', 0);
update_option('concerto_design_borders_comment', 0);
update_option('concerto_design_borders_comment_top', 0);
update_option('concerto_design_borders_comment_bottom', 1);
update_option('concerto_design_borders_commentlist_top', 1);
