...
<div class="wrap concerto">
	...
	<div class="concerto_notice level_updated">Your <strong><?php echo @implode(' &amp; ', array_map('ucfirst',explode(',', $_GET['restored_context']))); ?></strong> configurations for stage "<strong><?php echo @ucfirst($_GET['restored_to']); ?></strong>" has been restored to their default values.</div>
	<?php } ?>
