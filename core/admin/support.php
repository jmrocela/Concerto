...
?>
	<div class="box box1column" id="concerto_about">
		...
		<div class="inner">
			<p>Concerto is a Powerful Theme Framework built on top of the powerful Wordpress Blogging platform. Concerto might be the only Theme you will need the rest of your life. Concerto provides the regular user to customize endlessly and enables the WordPress developer and Designer great deal of flexibility.</p>
			<p>For more in-depth explanation of what Concerto has to offer, visit <a href="http://themeconcert.com" target="_blank">Themeconcert</a></p>
			<p>Copyright &#0169; 2010 Concerto, Themeconcert.</p>
		</div>
	</div>
<?php
}
...
?>
	<div class="box box1column" id="concerto_support">
		...
		<div class="inner">
			<p>For customer support, please email <a href="mailto:support@themeconcert.com">support@themeconcert.com</a>. We will reply to everyone's messages. The usual response time for messages is less than 6 hours and will not be automated.</p>
			<p>For a much quicker solution, please visit the <a href="http://themeconcert.com/community/">Concerto Community</a> and post your question there. Our growing community will be glad to help you in your problem.</p>
		</div>
	</div>
<?php
}
...
?>
	<div class="box box2columns" id="concerto_terms_and_agreements">
		...
		<div class="inner">
			<p>Please read the gist of Concerto's Terms &amp; Agreements. As a customer, it is your right to know the things usually overlooked.</p>
			...
			<p>You can read the whole Terms &amp; Agreement document online <a href="http://themeconcert.com/members/licenses/<?php echo get_option('concerto_license'); ?>" target="_blank">Here</a>.</p>
		</div>
	</div>
<?php
}
...
?>
	<div class="box box1column" id="concerto_search">
		...
		<div class="inner">
			<p>Are you stuck? Check the Manual with this convenient Search Tool.</p>
