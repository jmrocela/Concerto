<?php if (get_option('concerto_options_columns') == 2 || true) { ?>
<section class="sidebars concerto_sidebar_main">
<?php do_action('concerto_before_sidebars'); ?>
<?php do_action('concerto_before_sidebar_1'); ?>
<ul>
...
<?php do_action('concerto_after_sidebar_1'); ?>
<?php do_action('concerto_after_sidebars'); ?>
</section>
<?php } ?>

<?php if (get_option('concerto_options_columns') == 3) { ?>
<section class="sidebars concerto_sidebar_secondary">
<?php do_action('concerto_before_sidebars'); ?>
<?php do_action('concerto_before_sidebar_2'); ?>
<ul>
...
<?php do_action('concerto_after_sidebar_2'); ?>
<?php do_action('concerto_after_sidebars'); ?>
</section>
<?php } ?>