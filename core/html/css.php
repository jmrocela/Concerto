...
if (!empty($fonts)) {
	foreach ($fonts as $font) {
		if ($font['source-type'] == 'fontface') {
			echo str_replace("\n", "", stripslashes($font['source'])) . "\n";
		}
	}
}
?>
...
a{color:<?php echo $colors['fonts']['link']; ?>;}
a:hover{color:<?php echo $colors['fonts']['link-hover']; ?>;}
#header{background-color:<?php echo $colors['background']['header']; ?><?php echo ($colors['background']['header-image']) ? ";background-image:url('" . $colors['background']['header-image'] . "');background-repeat:no-repeat;background-position:center;background-attachment:scroll": ''; ?>;}
#header .container{padding:<?php echo get_option('concerto_' . $stage . '_design_page_padding'); ?>px;background-color:transparent;}
...
#branding #site-description{font-size:<?php echo $sizes['header-description']; ?>px;color:<?php echo $colors['fonts']['header-description']; ?>;}
#access{margin-bottom:-<?php echo $borders['menu']; ?>px;background-color:<?php echo $colors['background']['header']; ?>;}
#access .menu,#menu-top-container .menu,#menu-footer-container .menu{width:<?php echo $width['container']; ?>px;padding:0 <?php echo get_option('concerto_' . $stage . '_design_page_padding'); ?>px;}
#access ul li a{font-size:<?php echo $sizes['menu']; ?>px;font-family:<?php echo $fonts['menu']; ?>;color:<?php echo $colors['fonts']['menu']; ?>;background-color:<?php echo $colors['background']['menu']; ?>;border:<?php echo $borders['menu']; ?>px solid;border-color:<?php echo $colors['borders']['menu']; ?>;border-bottom:<?php echo $borders['menu']; ?>px solid;border-color:<?php echo $colors['borders']['menu-active']; ?>;}
...
#access ul li ul.children,#access ul li ul.sub-menu{border:<?php echo $borders['menu']; ?>px solid;border-color:<?php echo $colors['borders']['menu-active']; ?>;margin-top:-<?php echo $borders['menu']; ?>px;}
#access ul li ul.children li a,#access ul li ul.sub-menu li a{border-top:<?php echo $borders['menu']; ?>px solid;border-color:<?php echo $colors['borders']['menu-active']; ?>;}
...
#footer{font-size:<?php echo $sizes['footer']; ?>px;border-top:<?php echo $borders['footer-top']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;background-color:<?php echo $colors['background']['footer']; ?>;color:<?php echo $colors['fonts']['footer']; ?>;}
#footer .container{padding:<?php echo get_option('concerto_' . $stage . '_design_page_padding') + 30; ?>px <?php echo get_option('concerto_' . $stage . '_design_page_padding'); ?>px;}
.sidebars{font-family:<?php echo $fonts['sidebar']; ?>;font-size:<?php echo $sizes['sidebar']; ?>px;line-height:<?php echo $sizes['sidebar'] + 7; ?>px;}
.concerto_sidebar_main{border-left:<?php echo $borders['container']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;width:<?php echo $width['sidebar1']; ?>px;margin-left:-<?php echo $borders['container']; ?>px;}
.concerto_sidebar_secondary{border-left:<?php echo $borders['container']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;width:<?php echo $width['sidebar2']; ?>px;}
...
.wrapped #main{background-color:<?php echo $colors['background']['content']; ?>;border-left:<?php echo $borders['container']; ?>px solid;border-left-color:<?php echo $colors['borders']['common']; ?>;border-right:<?php echo $borders['container']; ?>px solid;border-right-color:<?php echo $colors['borders']['common']; ?>;}
.type-post,.type-page{padding:<?php echo get_option('concerto_' . $stage . '_design_article_padding'); ?>px <?php echo get_option('concerto_' . $stage . '_design_article_padding'); ?>px;margin-bottom:<?php echo get_option('concerto_' . $stage . '_design_page_padding') + 50; ?>px;}
...
.entry-utility #entry-author-info{border: 1px solid;border-color:<?php echo $colors['borders']['common']; ?>;background-color:<?php echo $colors['background']['header']; ?>;}
...
#content .sticky{border-left:5px solid;border-left-color:<?php echo $colors['borders']['common']; ?>;padding:<?php echo get_option('concerto_' . $stage . '_design_article_padding'); ?>px;padding-left:<?php echo get_option('concerto_' . $stage . '_design_article_padding') + 10; ?>px;}
#content .entry-content hr{border:0;border-top:1px solid;border-color:<?php echo $colors['borders']['common']; ?>;height:1px;}
#content a.more-link{color:<?php echo $colors['fonts']['link']; ?>;}
#content a.more-link:hover{color:<?php echo $colors['fonts']['link-hover']; ?>;}
...
#content table{border:1px solid;border-color:<?php echo $colors['borders']['common']; ?>;}
#content table td,#content table th{border-bottom:<?php echo $borders['table']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;}
...
.commentlist{font-family:<?php echo $fonts['content']; ?>;border-top:<?php echo $borders['commentlist-top']; ?>px solid;border-color:<?php echo $colors['borders']['commentlist-top']; ?>;border-bottom:<?php echo $borders['commentlist-bottom']; ?>px solid;border-color:<?php echo $colors['borders']['commentlist-bottom']; ?>;}
.commentlist li.comment{border-top:<?php echo $borders['comment-top']; ?>px solid;border-color:<?php echo $colors['borders']['comment-top']; ?>;border-bottom:<?php echo $borders['comment-bottom']; ?>px solid;border-color:<?php echo $colors['borders']['comment-bottom']; ?>;}
.commentlist li:last-child{border-bottom:none;}
.pinglist{border-bottom:1px solid;border-color:<?php echo $colors['borders']['comment-bottom']; ?>;}
...
.widget_search{border:1px solid;border-color:<?php echo $colors['borders']['common']; ?>;}
...
/*columns*/
.column2order.normal-page #content{border-left:<?php echo $borders['container']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;}
.column2order .sidebars{border-right:<?php echo $borders['container']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;}
.column2order.normal-page #content{border-left:<?php echo $borders['container']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;}
.column2order .sidebars{<?php echo $borders['container']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;margin-right:-<?php echo $borders['container']; ?>px;}
.column3order .concerto_sidebar_main{margin-left:-<?php echo $borders['container']; ?>px;}
.column4order.normal-page #content{border-left:<?php echo $borders['container']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;}
.column4order .concerto_sidebar_main{border-right:<?php echo $borders['container']; ?>px solid;border-color:<?php echo $colors['borders']['common']; ?>;margin-right:-<?php echo $borders['container']; ?>px;}
...
#access, #access ul li, #access ul li a, #access ul li a:hover, #access ul li:hover, #access ul li:hover a, #access ul li.current_page_item a, #access ul li.current_page_item a:hover,
